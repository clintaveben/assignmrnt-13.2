...
#Q)a. Find out top 5 attributes having highest correlation (select only Numeric features).
#Q)b. Find out top 3 reasons for having more crime in a city.
#Q)c. Which all attributes have high correlation with crime rate?
